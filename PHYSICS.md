...
Un compteur `$19D12` d�compte � chaque appel ; � z�ro il est recharg� � **30** et la
routine choisit une cible de service.

## Cas g�n�ral � tous sauf Bejin et Biff
...
## Bejin (`$1B5AC == 6`) � le service t�l�kin�sique
...
Deux bits tir�s au hasard, et **le son jou� d�pend du bit qui d�cide de la
direction**. C'est l'indice sonore : �couter son service permet de l'anticiper.
M�canique confirm�e dans le code d'origine.
...
**Le service de Biff s'ajuste � l'�cart de score.** C'est une adaptation au
d�roulement du match, pas une d�gradation dans le temps.
